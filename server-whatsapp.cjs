// Servidor WhatsApp real usando whatsapp-web.js (CommonJS)
...
// Assegurar que o diretório de sessões existe
...
app.listen(PORT, '0.0.0.0', () => {
  ...
  console.log(`Acesse o servidor em: http://localhost:${PORT}/api/whatsapp/status`);
